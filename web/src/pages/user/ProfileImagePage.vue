<template>
  ...
  <div class="q-pa-lg" v-else>
    Profile Image is not editable for OAuth users.
  </div>
  <!-- <div>
    <q-file
      v-model="files"
...
console.log('Debugging - profileImage: ', profileImage);
...
//         serviceDivision: 'profile-image',
//       },
//     };
//     for (let i = 0; i < files.value.length; i++) {
//       formData.append('file', files.value[i]);
//       formData.append('service', 'user_service');
//       formData.append('serviceDivision', 'profile-image');
//     }
